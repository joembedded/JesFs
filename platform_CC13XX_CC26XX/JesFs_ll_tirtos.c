...
*
* Tested on CC1310, CC1312 and CC2652 Launchpads
*
* Special notes for TI-RTOS:
* - There is a blocking waiting function used (CPUdelay() in sflash_wait_usec()).
*   It may be replaced by a TI-RTOS waiting function (like Task_wait(), etc..
* - During SPI select active, the RED Led (Launchpad) is on. While waiting, it is toggeling,
